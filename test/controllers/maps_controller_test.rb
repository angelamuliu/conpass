...
class MapsControllerTest < ActionController::TestCase
  ...
  test "should create map" do
    assert_difference('Map.count') do
      post :create, map: { convention_id: @map.convention_id, end_date: @map.end_date, name: @map.name, start_date: @map.start_date }
    end
  ...
  test "should update map" do
    patch :update, id: @map, map: { convention_id: @map.convention_id, end_date: @map.end_date, name: @map.name, start_date: @map.start_date }
    assert_redirected_to map_path(assigns(:map))
  end
